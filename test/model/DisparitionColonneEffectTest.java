 ...
 * @author hugol
 */
public class DisparitionColonneEffectTest {
    
     static Game aGame;

    
    public DisparitionColonneEffectTest() {
    }
     ...
     */
    @Test
    public void testDisappearColonneEffectNormalGame() {
        ...
        aGame.getBoard().getTileIJ(height - 3, 0).setEffect(new DisparitionColoneEffet());
        ...
        assertTrue("Doit être d'effet colonne", aGame.getBoard().getTileIJ(height - 3, 0).getEffect() instanceof DisparitionColoneEffet);
     ...
     */
    @Test
    public void testDisparitionColoneEffetEmptyGame() {

        // Effet fixé sur une case 
        int height = aGame.getBoard().getHeight();
        aGame.getBoard().getTileIJ(height - 1, 0).setEffect(new DisparitionColoneEffet());
        ...
        //assertTrue("Doit être d'effet disappear", aGame.getBoard().getTileIJ(height - 1, 0).getEffect() instanceof DisparitionColoneEffet);
        assertTrue(aGame.getCurrentPlayer().getId() != id_player);
     ...
     */
    @Test
    public void testDisparitionColoneEffetEmptyGameWithTilesNumber() {
    ...
    public void testDisappearEffectFilledGame() {
        ...
        assertTrue("Doit être d'effet disappear", aGame.getBoard().getTileIJ(height - 3, 0).getEffect() instanceof DisparitionColoneEffet);
        assertTrue(aGame.getCurrentPlayer().getId() != id_player);
